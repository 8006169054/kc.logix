package kc.logix.apps.management.website;
...
//				.addData(PortList)
	...
	public ResponseEntity<InputStreamResource> arrivalNoticeSendMail(@RequestBody WebsiteDto paramDto, @KainosSession SessionDto session) throws Exception {
