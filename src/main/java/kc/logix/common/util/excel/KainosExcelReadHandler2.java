...
//public class KainosExcelReadHandler2 implements SheetContentsHandler {
//
//	@Builder.Default
...
//     * @throws Exception
//     */
//	public KainosExcelReadHandler2 readExcel() throws Exception {
...
//            ContentHandler handle = new XSSFSheetXMLHandler(styles, strings, KainosExcelReadHandler2.this, false);
...
//            throw e;
//        }
//        return KainosExcelReadHandler2.this;
//    }
//	
//	@Override
...
//		System.out.println(cellReference.replaceAll("[^a-zA-Z]", "").toUpperCase() + " : " + formattedValue);
