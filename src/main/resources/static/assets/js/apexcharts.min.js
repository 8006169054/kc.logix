        ...
        return r(t, [{
            ...
            value: function(t) {
                ...
                if (a && "object" === i(a)) {
                    ...
                    a.chart.stacked && "bar" === a.chart.type && (l = r.stackedBars()),
      ...
      , lt = function() {
        ...
        return r(t, [{
            ...
            value: function() {
                ...
                e.globals.dom.elWrap.appendChild(e.globals.dom.elLegendWrap),
      ...
      , ut = function() {
        ...
        return r(t, [{
            ...
            value: function(t) {
                ...
                if (e.globals.isXNumeric ? (r && !c && (o -= a % 2 != 0 ? l / 2 : 0),
                r && c && e.globals.comboCharts && (o -= l / 2)) : e.globals.isBarHorizontal || (o = i.xAxisTicksPositions[t - 1] + i.dataPointsDividedWidth / 2,
                isNaN(o) && (o = i.xAxisTicksPositions[t] - i.dataPointsDividedWidth / 2)),
                e.globals.isBarHorizontal ? n -= i.tooltipRect.ttHeight : e.config.tooltip.followCursor ? n = i.e.clientY - h.top - i.tooltipRect.ttHeight / 2 : n + i.tooltipRect.ttHeight + 15 > e.globals.gridHeight && (n = e.globals.gridHeight),
        ...
        return r(t, [{
            ...
            value: function(t) {
                ...
                if (c.globals.isXNumeric)
                    ...
                    e = n + (a = this.seriesLen * a / u) * this.visibleI,
                    e -= a * f
                }
            ...
            value: function(t) {
                ...
                if (c.globals.isXNumeric) {
                    var p = d;
                    c.globals.seriesX[d].length || (p = c.globals.maxValsInArrayIndex),
                    c.globals.seriesX[p][u] && (a = (c.globals.seriesX[p][u] - c.globals.minX) / this.xRatio - o * this.seriesLen / 2),
                    e = a + o * this.visibleI
                } else if (c.config.plotOptions.bar.hideZeroBarsWhenGrouped) {
                    var x = 0
                      , b = 0;
                    ...
                    e = a + (o = this.seriesLen * o / x) * this.visibleI,
                    e -= o * b
                }
