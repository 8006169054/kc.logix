	...
	$(tableName).jqGrid({
	   	...
	   	colModel: [
			...
			{ name: 'mblNo', 				width: 140, 	align:'center',		rowspan: true},
	       	{ name: 'sales', 				width: 50, 		align:'center',		rowspan: true},
	       	{ name: 'carryoverSales', 		width: 50, 		align:'center',		rowspan: true},
	       	{ name: 'arrivalNotice',		width: 70, 		align:'center',		rowspan: true, formatter: arrivalNoticeFn},
	       	{ name: 'invoice', 				width: 70, 		align:'center',		rowspan: true, formatter: invoiceFn},
	    	{ name: 'concine', 				width: 150, 	align:'center',		rowspan: true},
	    	{ name: 'profitDate', 			width: 90, 		align:'center',		rowspan: true},
	    	{ name: 'domesticSales', 		width: 80, 		align:'center',		rowspan: true, formatter: domesticSalesFn},
	    	{ name: 'foreignSales', 		width: 80, 		align:'center',		rowspan: true, formatter: foreignSalesFn},
	    	{ name: 'quantity', 			width: 50, 		align:'center',		rowspan: true},
	    	{ name: 'partner', 				width: 120, 	align:'center',		cellattr:idColorFmt},
